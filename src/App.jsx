...
function App() {
  ...
  useEffect(() => {
    const fetchGithubData = async () => {
      try {
        const response = await axios.get('https://api.github.com/users/Ritika2484');
        ...
        setGithubData({
          ...
          followers: "10+",
          following: "10+",
          html_url: "https://github.com/Ritika2484"
        });
      }
    };
    fetchGithubData();
    ...
    <>
      ...
      <nav className={`navbar ${scrolled ? 'scrolled' : ''}`}>
        <div className="nav-content">
          <a href="#" className="logo" onClick={closeMenu}>RK</a>
          ...
          >
            <div className="container hero" style={{ paddingTop: '8rem', paddingBottom: '4rem', zIndex: 10 }}>
              <div className="hero-content">
                ...
                >
                  RITIKA<br /><span className="gradient-text">KAUSHIK</span>
                </motion.h1>
                <motion.h2
                  initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ delay: 0.3, duration: 1 }}
                  className="hero-subtitle"
                >
                  <Typewriter words={["Frontend Developer", "Full Stack Developer", "Problem Solver"]} />
                ...
                <motion.p
                  ...
                  className="hero-desc"
                >
                  Passionate about building scalable web applications and delivering high-performance, responsive UI with modern design principles.
                </motion.p>
                <motion.div
                ...
                >
                  ...
                  <a href="/ritika.pdf" download className="btn btn-outline"><i className="fas fa-download"></i> Resume</a>
                ...
                >
                  <a href="https://github.com/Ritika2484" target="_blank" rel="noreferrer"><i className="fab fa-github"></i></a>
                  <a href="https://www.linkedin.com/in/ritika-kaushik24" target="_blank" rel="noreferrer"><i className="fab fa-linkedin"></i></a>
                  <a href="mailto:ritikakaushik2484@gmail.com"><i className="fas fa-envelope"></i></a>
                </motion.div>
              </div>
              ...
              <Tilt tiltMaxAngleX={5} tiltMaxAngleY={5} glareEnable={true} glareMaxOpacity={0.1} glarePosition="all" style={{ zIndex: 10, display: 'flex', justifyContent: 'center', alignItems: 'center' }}>
                ...
                >
                  ...
                  <img src="/profile.jpeg" alt="Ritika Kaushik" style={{ width: '100%', maxWidth: '450px', height: 'auto', display: 'block', margin: '0 auto', objectFit: 'cover', borderRadius: '40px', border: '1px solid rgba(0,0,0,0.05)', boxShadow: '0 30px 60px -15px rgba(0, 0, 0, 0.25)' }} />
                </motion.div>
              </Tilt>
            </div>
          </WavyBackground>
          ...
          <div className="container">
            ...
            <div className="about-grid">
              <TiltCard delay={0.1} className="about-card">
                ...
                <p className="highlight" style={{ marginTop: '0.5rem' }}>CGPA: 6.89</p>
              </TiltCard>
              <TiltCard delay={0.2} className="about-card">
                ...
                <p>Strong interest in frontend UI development, reactive applications, database management, and building robust backend services. Driven by a problem-solving mindset and continuous learning.</p>
              </TiltCard>
            </div>
          </div>
        </section>
          ...
          <div className="container">
            ...
            <div className="skills-grid">
              ...
              <TiltCard delay={0.2} className="skill-category">
                ...
                <div className="skill-tags">
                  <span>ReactJS</span><span>Tailwind CSS</span><span>NodeJS</span><span>ExpressJS</span><span>Mongoose</span>
                </div>
              </TiltCard>
              <TiltCard delay={0.3} className="skill-category">
                <h3><i className="fas fa-database"></i> Tools</h3>
                <div className="skill-tags">
                  <span>MongoDB</span><span>MySQL</span><span>PostgreSQL</span><span>Postman</span><span>Git</span><span>Vercel</span>
                </div>
              </TiltCard>
              <TiltCard delay={0.4} className="skill-category">
                <h3><i className="fas fa-users"></i> Soft Skills</h3>
                <div className="skill-tags">
                  <span>Problem-Solving</span><span>Team Player</span><span>Adaptability</span><span>Leadership</span>
                </div>
              </TiltCard>
            </div>
          </div>
            ...
            <div className="projects-grid">
              <TiltCard delay={0.1} className="project-card">
                <div className="project-tags">
                  <span>ReactJS</span><span>ExpressJS</span><span>MongoDB</span><span>NodeJS</span>
                </div>
                <h3>Magic-Tales – Story Book for Children</h3>
                <p>Developed an interactive animation-based web platform enabling users to explore engaging animated content through a smooth and responsive interface. Delivered rich animated experiences, real-time content updates, and secure data management.</p>
                <div className="project-links">
                  <a href="https://github.com/Ritika2484" className="btn btn-outline btn-sm"><i className="fab fa-github"></i> GitHub</a>
                </div>
              </TiltCard>
              <TiltCard delay={0.2} className="project-card">
                ...
                <h3>AI–Powered Log Management System</h3>
                <p>Developed a role-based AI Log Management System enabling secure authentication, question handling, and real-time access to stored data. Enabled intelligent search and admin-controlled updates to improve data retrieval efficiency.</p>
                <div className="project-links">
                  <a href="https://github.com/Ritika2484" className="btn btn-outline btn-sm"><i className="fab fa-github"></i> GitHub</a>
                </div>
              </TiltCard>
            ...
            <div className="timeline">
              <FadeIn delay={0.1} className="timeline-item">
                ...
                <div className="timeline-content">
                  <span className="timeline-date">Aug '25 - Jan '26</span>
                  <h3>Frontend Developer Intern</h3>
                  <h4 className="gradient-text">Local Startup KIRIJO (IIT Guwahati)</h4>
                  <ul>
                    <li>Led the frontend development of the Kirijo prototype using React + Vite, delivering a responsive, high-performance UI from Figma mockups.</li>
                    <li>Implemented modular components, client-side routing, and optimized performance through lazy loading and bundle size reduction.</li>
                    <li>Collaborated remotely with backend and design teams to integrate APIs, handle asynchronous data, and ensure smooth user experience.</li>
                  </ul>
                </div>
              </FadeIn>
            </div>
            ...
            <div className="dual-grid">
              <FadeIn delay={0.1}>
                ...
                <ul className="fancy-list">
                  <li><i className="fas fa-award"></i><div><strong><a href="https://www.udemy.com/certificate/UC-219223ae-c54d-4709-aca0-8add38ffd170/" target="_blank" rel="noreferrer" style={{ color: 'inherit', textDecoration: 'none', transition: 'color 0.3s' }} onMouseOver={(e) => e.target.style.color = 'var(--primary-blue)'} onMouseOut={(e) => e.target.style.color = 'inherit'}>PHP Laravel <i className="fas fa-external-link-alt" style={{ fontSize: '0.8rem', marginLeft: '0.3rem' }}></i></a></strong><span>Udemy (Mar '26)</span></div></li>
                  <li><i className="fas fa-award"></i><div><strong><a href="https://www.hackerrank.com/certificates/1be52bfb6f88" target="_blank" rel="noreferrer" style={{ color: 'inherit', textDecoration: 'none', transition: 'color 0.3s' }} onMouseOver={(e) => e.target.style.color = 'var(--primary-blue)'} onMouseOut={(e) => e.target.style.color = 'inherit'}>Problem Solving Skills <i className="fas fa-external-link-alt" style={{ fontSize: '0.8rem', marginLeft: '0.3rem' }}></i></a></strong><span>HackerRank (Mar '26)</span></div></li>
                  <li><i className="fas fa-award"></i><div><strong><a href="/Ritika_Kaushik.pdf" target="_blank" rel="noreferrer" style={{ color: 'inherit', textDecoration: 'none', transition: 'color 0.3s' }} onMouseOver={(e) => e.target.style.color = 'var(--primary-blue)'} onMouseOut={(e) => e.target.style.color = 'inherit'}>Comp. Coding & DP <i className="fas fa-external-link-alt" style={{ fontSize: '0.8rem', marginLeft: '0.3rem' }}></i></a></strong><span>CipherSchools (Jan '26)</span></div></li>
                  <li><i className="fas fa-award"></i><div><strong><a href="/Screenshot_Privacy.png" target="_blank" rel="noreferrer" style={{ color: 'inherit', textDecoration: 'none', transition: 'color 0.3s' }} onMouseOver={(e) => e.target.style.color = 'var(--primary-blue)'} onMouseOut={(e) => e.target.style.color = 'inherit'}>Privacy & Security in Social Media <i className="fas fa-external-link-alt" style={{ fontSize: '0.8rem', marginLeft: '0.3rem' }}></i></a></strong><span>NPTEL (Apr '25)</span></div></li>
                </ul>
              </FadeIn>
              <FadeIn delay={0.2}>
                ...
                <div className="stats-grid">
                  ...
                  <Tilt tiltMaxAngleX={10} tiltMaxAngleY={10} glareEnable={true} glareMaxOpacity={0.1} glareColor="var(--primary-blue)" style={{ gridColumn: '1 / -1', height: '100%' }}>
                    <div className="minimal-card stat-card" style={{ height: '100%' }}>
                      <div className="stat-number"><i className="fas fa-star" style={{ fontSize: '2.5rem', verticalAlign: 'middle', marginRight: '5px' }}></i>5</div>
                      <div className="stat-label">Problem Solving (HackerRank)</div>
                    </div>
                  </Tilt>
                </div>
              </FadeIn>
            ...
            <div className="dual-grid">
              <div className="timeline">
                <FadeIn delay={0.1} className="timeline-item">
                  <div className="timeline-dot"></div>
                  <div className="timeline-content">
                    <span className="timeline-date">Aug '23 - Present</span>
                ...
                <FadeIn delay={0.2} className="timeline-item">
                  <div className="timeline-dot"></div>
                  <div className="timeline-content">
                    <span className="timeline-date">Apr '21 - Mar '22</span>
                    <h3>Madhav Public School</h3>
                    <p className="highlight">Score: 84%</p>
                  </div>
                </FadeIn>
                <FadeIn delay={0.3} className="timeline-item">
                  <div className="timeline-dot"></div>
                  <div className="timeline-content">
                    <span className="timeline-date">Apr '19 - Mar '20</span>
                    <h3>Saraswati Balika Vidyalaya</h3>
                    <p className="highlight">Score: 94%</p>
                  </div>
                </FadeIn>
              </div>
              <div style={{ display: 'flex', flexDirection: 'column', gap: '2rem' }}>
                <TiltCard delay={0.3} className="comp-card">
                  ...
                  <div className="cp-links">
                    <a href="https://leetcode.com/" target="_blank" rel="noreferrer" className="btn btn-outline btn-sm">LeetCode</a>
                    <a href="https://www.hackerrank.com/" target="_blank" rel="noreferrer" className="btn btn-outline btn-sm">HackerRank</a>
                  </div>
                </TiltCard>
            ...
            <div className="contact-container">
              <FadeIn delay={0.1} className="minimal-card contact-info" style={{ background: 'transparent', border: 'none', padding: 0 }}>
                ...
                <div className="contact-methods">
                  <a href="mailto:ritikakaushik2484@gmail.com" className="contact-method">
                    <div className="cm-icon"><i className="fas fa-envelope"></i></div>
                    <div>
                      <h4>Email</h4>
                      <span>ritikakaushik2484@gmail.com</span>
                    </div>
                  </a>
                  <a href="tel:+919369554806" className="contact-method">
                    <div className="cm-icon"><i className="fas fa-phone"></i></div>
                    <div>
                      <h4>Phone</h4>
                      <span>+91-9369554806</span>
                    </div>
                  </a>
                </div>
              </FadeIn>
      ...
      <footer>
        <div className="container footer-content">
          <p>&copy; {new Date().getFullYear()} Ritika Kaushik. All rights reserved.</p>
